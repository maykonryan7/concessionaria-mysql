...
<nav class="navbar navbar-expand-lg bg-dark" data-bs-theme="dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php">MKconcessionaria
	</a>
				  ...
				  include('config.php');
					...
					switch (@$_REQUEST['page']) {
						...
						case 'salvar-venda':
							...
							break;																					
					default:
						print "<h1>Seja bem vindo a MKconcessionaria</h1>";
...
<footer class="bg-dark text-light py-4 mt-5">
	<div class="container">
		<div class="border-top border-secondary pt-4 text-center">
			<p class="mb-1"><strong>Desenvolvido por: Maykon Ryan	</p>
			<p class="mb-0">&copy; 2025 Concessionária MK - Todos os direitos reservados</p>
		</div>
	</div>
</footer>
